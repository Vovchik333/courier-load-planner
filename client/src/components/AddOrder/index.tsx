...
export const AddOrder: React.FC<AddOrderProps> = ({ selectedDate }) => {
  ...
  return (
    ...
    >
      ...
      <Field>
        ...
        <Input id="hour" name="hour" type="number" defaultValue="10" min="10" max="17" required />
      </Field>
      <Field>
      ...
      <Field>
        ...
        <Input id="work-units" name="work-units" type="number" defaultValue="3" min="1" required />
      </Field>
      {createOrder.isError && (
